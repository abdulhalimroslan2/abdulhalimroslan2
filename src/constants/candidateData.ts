...
export const CHAPTERS: ChapterData[] = [
  {
    ...
    chapterNumber: '01',
    title: 'THE EDUCATOR',
    subtitle: 'ABDUL HALIM BIN ROSLAN',
    tagline: 'Guru, pendidik STEM & pencipta kandungan digital. 16 tahun dalam pendidikan.',
    timeRange: [0.00, 0.10],
    videoTimeRange: [0, 2.10],
    depthScale: '10⁰ m',
    coordinates: '5.1687° N, 100.4855° E',
    primaryColor: '#00f0ff',
    themeGlow: 'rgba(0, 240, 255, 0.35)',
    narrativeFlow: 'Abdul Halim bin Roslan • Pendidik STEM'
  },
  {
    id: 2,
    chapterNumber: '02',
    title: 'THE VISION',
    subtitle: 'Dari Guru kepada Inovator',
    tagline: 'Mengubah idea pendidikan menjadi penyelesaian digital.',
    timeRange: [0.10, 0.20],
    videoTimeRange: [2.10, 4.20],
    depthScale: '10⁰ m → 10⁻³ m',
    coordinates: '5.1687° N, 100.4855° E',
    primaryColor: '#38bdf8',
    themeGlow: 'rgba(56, 189, 248, 0.35)',
    narrativeFlow: 'Idea Pendidikan → Penyelesaian Digital'
  },
  {
    id: 3,
    chapterNumber: '03',
    title: 'THE CREATOR',
    subtitle: 'Membina Ekosistem Digital',
    tagline: 'MyPhysicsTutor, PhysFlix, PhysPlot, HeadcountPro, CIDS Suites Pro & CikguScan.',
    timeRange: [0.20, 0.30],
    videoTimeRange: [4.20, 6.30],
    depthScale: '10⁻³ m → 10⁻⁵ m',
    coordinates: '5.1687° N, 100.4855° E',
    primaryColor: '#06b6d4',
    themeGlow: 'rgba(6, 182, 212, 0.35)',
    narrativeFlow: '6 Inovasi Aplikasi Digital Pendidikan'
  },
  {
    id: 4,
    chapterNumber: '04',
    title: 'THE IMPACT',
    subtitle: 'Teknologi yang Memudahkan',
    tagline: 'Memperkasa pembelajaran murid, PdP guru dan analisis akademik.',
    timeRange: [0.30, 0.40],
    videoTimeRange: [6.30, 8.40],
    depthScale: '10⁻⁵ m → 10⁻⁶ m',
    coordinates: '4.5921° N, 101.0901° E',
    primaryColor: '#ff0055',
    themeGlow: 'rgba(255, 0, 85, 0.35)',
    narrativeFlow: 'Pembelajaran Murid • PdP Guru • Analisis Data'
  },
  {
    id: 5,
    chapterNumber: '05',
    title: 'THE CONTRIBUTOR',
    subtitle: 'Berkongsi, Membimbing, Membina',
    tagline: 'Panel pakar, pembangunan modul, penceramah & perkongsian inovasi pendidikan.',
    timeRange: [0.40, 0.50],
    videoTimeRange: [8.40, 10.50],
    depthScale: '10⁻⁶ m → 10⁻⁸ m',
    coordinates: '3.1390° N, 101.6869° E',
    primaryColor: '#ec4899',
    themeGlow: 'rgba(236, 72, 153, 0.35)',
    narrativeFlow: 'Panel Pakar • Modul KPM • Penceramah'
  },
  {
    id: 6,
    chapterNumber: '06',
    title: 'THE RECOGNITION',
    subtitle: 'Inovasi yang Diiktiraf',
    tagline: 'Emas IIEF 2025, Emas I3EC’25, Perak INNOZILLA & Johan Inovasi Kerian.',
    timeRange: [0.50, 0.60],
    videoTimeRange: [10.50, 12.60],
    depthScale: '10⁻⁸ m → 10⁻⁹ m',
    coordinates: '3.1390° N, 101.6869° E',
    primaryColor: '#a855f7',
    themeGlow: 'rgba(168, 85, 247, 0.35)',
    narrativeFlow: 'Emas IIEF • Emas I3EC • Johan Inovasi'
  },
  {
    id: 7,
    chapterNumber: '07',
    title: 'THE KNOWLEDGE',
    subtitle: 'Menulis untuk Generasi',
    tagline: 'Modul Fizik, CheatNote, bahan digital & penerbitan pendidikan.',
    timeRange: [0.60, 0.70],
    videoTimeRange: [12.60, 14.70],
    depthScale: '10⁻⁹ m → 10⁻² m',
    coordinates: '2.9264° N, 101.6964° E',
    primaryColor: '#6366f1',
    themeGlow: 'rgba(99, 102, 241, 0.35)',
    narrativeFlow: 'Modul Fizik SPM • CheatNote • Bahan Digital'
  },
  {
    id: 8,
    chapterNumber: '08',
    title: 'THE LEGACY',
    subtitle: 'Lebih daripada Teknologi',
    tagline: 'Membina budaya inovasi dan pendigitalan pendidikan.',
    timeRange: [0.70, 0.80],
    videoTimeRange: [14.70, 16.80],
    depthScale: '10⁻² m → 10⁻³ m',
    coordinates: '2.9264° N, 101.6964° E',
    primaryColor: '#3b82f6',
    themeGlow: 'rgba(59, 130, 246, 0.35)',
    narrativeFlow: 'Budaya Inovasi & Pendigitalan Pendidikan'
  },
  {
    id: 9,
    chapterNumber: '09',
    title: 'THE JOURNEY',
    subtitle: '16 Tahun. Satu Visi.',
    tagline: 'Daripada pengalaman kepada inovasi yang memberi impak.',
    timeRange: [0.80, 0.90],
    videoTimeRange: [16.80, 18.90],
    depthScale: '10⁻³ m → 10⁻¹ m',
    coordinates: '5.1687° N, 100.4855° E',
    primaryColor: '#10b981',
    themeGlow: 'rgba(168, 85, 247, 0.35)',
    narrativeFlow: '16 Tahun Pengalaman → Impak Pendidikan'
  },
  {
    id: 10,
    chapterNumber: '10',
    title: 'THE FUTURE',
    subtitle: 'ABDUL HALIM BIN ROSLAN',
    tagline: 'Pendidik. Inovator. Pencipta Kandungan Digital. Membina masa depan pendidikan, satu inovasi pada satu masa.',
    timeRange: [0.90, 1.00],
    videoTimeRange: [18.90, 21.00],
    depthScale: '10⁻¹ m → 10⁰ m',
    coordinates: '5.1687° N, 100.4855° E',
    primaryColor: '#eab308',
    themeGlow: 'rgba(234, 179, 8, 0.45)',
    narrativeFlow: 'Pendidik • Inovator • Masa Depan Pendidikan'
  }
];

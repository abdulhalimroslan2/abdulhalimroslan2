...
export const CHAPTERS: ChapterData[] = [
  {
    ...
    chapterNumber: '01',
    title: 'THE EDUCATOR',
    subtitle: 'Nadi Pendidik & Permulaan Inovasi',
    tagline: 'Abdul Halim bin Roslan • 16 Tahun Dedikasi',
    timeRange: [0.00, 0.10],
    ...
    narrativeFlow: 'Cikgu Halim • SMK Agama Kerian'
  },
  {
    id: 2,
    chapterNumber: '02',
    title: 'THE INITIATION',
    subtitle: 'Sentuhan Stylus & Digitizer',
    tagline: 'Input Fizikal ke Isyarat Digital',
    timeRange: [0.10, 0.20],
    ...
    narrativeFlow: 'Digital Stylus → Digitizer Glass Surface'
  },
  {
    id: 3,
    chapterNumber: '03',
    title: 'QUANTUM LATTICE',
    subtitle: 'Matriks Sub-Piksel & Isyarat Mikro',
    tagline: 'Denyutan Isyarat Skala Mikroskopik',
    timeRange: [0.20, 0.30],
    ...
    narrativeFlow: 'Sub-Pixel Grid → Capacitive Sensor Grid'
  },
  {
    id: 4,
    chapterNumber: '04',
    title: 'DATA HIGHWAY',
    subtitle: 'Lebuhraya Kabel Reben & Khidmat Dedikasi',
    tagline: '16 Tahun Aliran Perkhidmatan & SKPMg2 96.79%',
    timeRange: [0.30, 0.40],
    ...
    narrativeFlow: 'Flexible Ribbon Cable → Bus Traces'
  },
  {
    id: 5,
    chapterNumber: '05',
    title: 'SILICON SUBSTRATE',
    subtitle: 'Substrat Silikon & Kuasa Pengkomputeran',
    tagline: 'Seni Bina Semikonduktor Skala Nano',
    timeRange: [0.40, 0.50],
    ...
    narrativeFlow: 'Silicon Wafer → Power Delivery Rails'
  },
  {
    id: 6,
    chapterNumber: '06',
    title: 'COMPUTATIONAL CORE',
    subtitle: 'Logik 0 & 1 & Ekosistem 6 Aplikasi',
    tagline: 'Transformasi Digital Pendidikan Berimpak Tinggi',
    timeRange: [0.50, 0.60],
    ...
    narrativeFlow: 'Logic Gates → 6 Software Ecosystems'
  },
  {
    id: 7,
    chapterNumber: '07',
    title: 'WAVE PROPAGATION',
    subtitle: 'Pancaran Gelombang RF Wi-Fi',
    tagline: 'Penyebaran Ilmu Merentas Udara',
    timeRange: [0.60, 0.70],
    ...
    narrativeFlow: '5GHz RF Antenna → Electromagnetic Pulse'
  },
  {
    id: 8,
    chapterNumber: '08',
    title: 'THE RECEPTOR',
    subtitle: 'Papan Penerima Unjuran & Panel STEM',
    tagline: 'Pencapaian Inovasi Emas Kebangsaan',
    timeRange: [0.70, 0.80],
    ...
    narrativeFlow: 'Projector Receiver IC → Demodulator'
  },
  {
    id: 9,
    chapterNumber: '09',
    title: 'OPTICAL PRISM',
    subtitle: 'Enjin Optik & Pembiasan Prisma',
    tagline: 'Pancaran Fotonik Cahaya Berwarna',
    timeRange: [0.80, 0.90],
    ...
    narrativeFlow: 'Dichroic Prism → Lens Assembly → Light Beam'
  },
  {
    id: 10,
    chapterNumber: '10',
    title: 'APEX RETINA & LEGACY',
    subtitle: 'Pencerahan Minda Pelajar & Legasi Masa Depan',
    tagline: 'Kitaran Lengkap: Dari Guru Kepada Generasi',
    timeRange: [0.90, 1.00],
    ...
    narrativeFlow: 'Pupil Reception → Neural Activation'
  }
];
